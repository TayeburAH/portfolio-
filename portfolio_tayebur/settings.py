"""
Django settings for portfolio_tayebur project.
...
SECRET_KEY = 'django-insecure-g*euwzy6p9hm&k$(z6j-*azj(1qnf*bho%2ydax0@d(d^bn^ku'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['tayebur-portfolio.herokuapp.com']
...
ROOT_URLCONF = 'portfolio_tayebur.urls'
...
WSGI_APPLICATION = 'portfolio_tayebur.wsgi.application'
